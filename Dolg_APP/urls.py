...
urlpatterns = [
    ...
    path("staff/ml-training/import/status/", ml_admin_views.ml_dataset_import_status,   name="ml_dataset_import_status"),
    ...
    path("projects/api/<int:pk>/simulation-runs/", views.api_project_simulation_runs, name="api_project_simulation_runs"),
    path("projects/api/<int:pk>/simulation-runs/stats/", views.api_project_simulation_stats, name="api_project_simulation_stats"),
    path("projects/api/<int:pk>/save-simulation/", views.api_project_save_simulation, name="api_project_save_simulation"),
    path("projects/api/<int:pk>/simulation/postprocess/", views.api_project_simulation_postprocess, name="api_project_simulation_postprocess"),
    path("projects/api/<int:pk>/simulation/<int:run_id>/export.csv", views.api_project_simulation_export_csv, name="api_project_simulation_export_csv"),
    path("projects/api/<int:pk>/measurements/", views.api_project_measurements, name="api_project_measurements"),
    path("projects/api/<int:pk>/measurements/create/", views.api_project_measurement_create, name="api_project_measurement_create"),
    path("projects/api/<int:pk>/review/", views.api_project_review_create, name="api_project_review_create"),
    path("projects/api/<int:pk>/review/latest/", views.api_project_review_latest, name="api_project_review_latest"),
    ...
    path("simulation/api/pro/monte-carlo/", views.api_simulation_monte_carlo, name="api_simulation_monte_carlo"),
    path("simulation/api/pro/signal-quality/", views.api_simulation_signal_quality, name="api_simulation_signal_quality"),
    path("simulation/api/pro/parameter-sweep/", views.api_simulation_parameter_sweep, name="api_simulation_parameter_sweep"),
    path("simulation/api/fallback-solve/", views.api_simulation_fallback_solve, name="api_simulation_fallback_solve"),
    ...
    path("orgs/<slug:org_slug>/members/<int:member_id>/role/",   org_views.org_member_role,   name="org_member_role"),
    path("orgs/<slug:org_slug>/members/<int:member_id>/remove/", org_views.org_member_remove, name="org_member_remove"),
    ...
    path("orgs/<slug:org_slug>/projects/<int:pk>/submit/",  org_views.project_submit_for_review, name="project_submit_for_review"),
    path("orgs/<slug:org_slug>/projects/<int:pk>/approve/", org_views.project_approve, name="project_approve"),
    ...
    path("2fa/backup/regenerate/", two_factor_views.two_factor_backup_codes_regenerate, name="two_factor_backup_regenerate"),
    ...
    path("orgs/<slug:org_slug>/api-tokens/create/", org_views.org_api_token_create, name="org_api_token_create"),
    path("orgs/<slug:org_slug>/api-tokens/<int:token_id>/revoke/", org_views.org_api_token_revoke, name="org_api_token_revoke"),
    ...
    path("chat/<int:topic_id>/reply/<int:reply_id>/accept/", chat_views.chat_reply_accept_answer, name="chat_reply_accept_answer"),
    ...
    path("orgs/<slug:org_slug>/conversations/",                          chat_views.org_conversation_list,           name="org_conversation_list"),
    path("orgs/<slug:org_slug>/conversations/new/",                      chat_views.org_conversation_create,         name="org_conversation_create"),
    path("orgs/<slug:org_slug>/conversations/<int:conv_id>/",            chat_views.org_conversation_detail,         name="org_conversation_detail"),
    path("orgs/<slug:org_slug>/conversations/<int:conv_id>/message/",    chat_views.org_conversation_message_create, name="org_conversation_message_create"),
    path("orgs/<slug:org_slug>/conversations/<int:conv_id>/archive/",    chat_views.org_conversation_archive,        name="org_conversation_archive"),
    path("orgs/<slug:org_slug>/conversations/<int:conv_id>/poll/",       chat_views.org_conversation_poll,           name="org_conversation_poll"),
]

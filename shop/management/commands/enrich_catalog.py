...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            '--skip-params', action='store_true', help='Не запускать enrich_product_parameters.'
        )
        parser.add_argument('--slug', type=str, default=None, help='Точечно один товар по slug (для теста).')
        parser.add_argument('--limit', type=int, default=0, help='Ограничить выборку (для теста).')

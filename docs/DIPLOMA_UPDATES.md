...
## 4. План перенумерации приложений (рисунки — цифрами!)

- Приложения переименовать буквами кириллицы подряд: **А, Б, В, Г, Д, Е**
  (1→А «Сводные сведения», 2→Б «Иллюстрации UI», 3→В «Диаграммы», 4→Г «Код», Д→Д «Контроль качества», Е→Е «Актуализация»).
- **Рисунки — сквозная числовая нумерация по всей работе: Рисунок 1, 2, 3 … N** (без букв и без «глава.номер»,
  раз научрук просит «только цифрами»). Сейчас в работе ~13 рисунков — пронумеровать 1…13 по порядку появления.

...
фронт работ теперь ведётся отдельно в `docs/WORK_FRONT_20260616.md`.
...
- `docs/WORK_FRONT_20260616.md` - единственный живой список работ.
...
- Собран текущий фронт работ `WORK_FRONT_20260616.md`, который заменяет старые scattered roadmap/backlog документы.
...
Смысл этих файлов перенесён сюда и в `WORK_FRONT_20260616.md`; сами файлы можно не восстанавливать:
...
- Что стало следующим активным пунктом в `WORK_FRONT_20260616.md`.
```

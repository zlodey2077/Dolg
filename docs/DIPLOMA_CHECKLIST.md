...
- 🔴 **Актуализация цифр (расхождение с реальной БД на 2026-06-08):**
  ...
  |---|---|---|
  | 89 товаров + 43 РЭБ (= 132) | **364 товара**, 23 категории | ⚠️ Скорее всего дубли от повторного сидинга. Почистить дубли ИЛИ пересчитать и обновить число. **Главное расхождение.** |
...
- 🔴 **Единая нумерация рисунков/таблиц/листингов внутри приложений по букве приложения.** Сейчас бардак:
  - Рисунки: «2.1…2.8» (Прил. 2), «3.1, 3.2, 3.3», затем «В.4, В.5» (Прил. 3) — смешаны стили.
  - Таблицы: «А.1», «1.2», «1.3», «А.4» (Прил. 1), «5.1, 5.2» (Прил. 5) — смешаны.
  Привести к: рисунки Приложения Б → **Рисунок Б.1, Б.2…**; таблицы Приложения А → **Таблица А.1, А.2…**;
  листинги Приложения Г → **Листинг Г.1, Г.2…**. Внутри каждого приложения — своя сквозная нумерация.
